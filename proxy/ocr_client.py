...
# DEPRECATED: solve_latex_ocr_question() function removed
# The LaTeX OCR integration functionality has been moved to local processing in proxy
# Use the LatexOCRIntegration class from latex_ocr_api_integration.py instead
# 
# Migration:
# OLD: solve_result = ocr_client.solve_latex_ocr_question(ocr_text, subject)
# NEW: integration = LatexOCRIntegration()
