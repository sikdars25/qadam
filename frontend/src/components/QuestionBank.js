...
const QuestionBank = () => {
  ...
  // Get unique papers and subjects for filters
  ...
  const filteredQuestions = questions.filter(q => {
    ...
    const matchesSubject = subjectFilter === 'all' ||
                          (subjectFilter === 'none' && !q.subject) ||
                          q.subject === subjectFilter;
    return matchesSearch && matchesPaper && matchesSubject;
  });
              ...
              {filteredQuestions.map((question, index) => (
                <tr key={question.id}>
                  ...
                  <td className="subject-cell">
                    {question.subject ? (
                      <span className="subject-badge" title={question.subject}>
                        {question.subject}
                      </span>
                    ) : (
                ...
                <div className="meta-row">
                  {selectedQuestion.subject && (
                    <span className="meta-item">
                      <strong>📚 Subject:</strong> {selectedQuestion.subject}
                    </span>
                  )}
                  <span className="meta-item">
